...
source = 'ZRH' # 'Source airport code'
destination = 'LON' # 'Destination airport code'
date = '06/17/2019' # 'MM/DD/YYYY'

# Based on https://www.scrapehero.com/scrape-flight-schedules-and-prices-from-expedia/
def parse(source,destination,date):
    ...
    for i in range(5):
        try:
            ...
            # E.g.: https://www.expedia.com/Flights-Search?trip=oneway&leg1=from:ZRH,to:LON,departure:06/17/2019TANYT&passengers=adults:1,children:0,seniors:0,infantinlap:Y&options=cabinclass%3Aeconomy&mode=search&origref=www.expedia.com
            ...
            print("Valerr, Retrying...")
        except:
            print("Unexpected err, Retrying...")
    if not ok:
        return {"error":"failed to get the page",}
    try:
